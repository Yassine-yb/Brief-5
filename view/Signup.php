    ...
    <div class="container d-flex justify-content-center align-items-center">
        <div class="card">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form">
                    <form action="http://localhost/gestion-emplois/signupCont/Ajout" method="post">
                        <h2>Registration</h2>
                ...
                <div class="col-md-6">
                    <div class="text-center mt-5"> <img src="http://localhost/gestion-emplois/public/images/registration.png" width="400"> </div>
                </div>
            </div>
        </div>
    </div>
